...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Electrician Finder web application - Approved Booking</title>
...
<?php } ?> 
                                         <td class="d-none d-sm-table-cell"><a href="view-booking-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-eye" aria-hidden="true"></i></a> || <a href="invoice-generating.php?invid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-file" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
