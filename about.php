...
<head>
	<title>Electrician Finder web application || About Us</title>
			...
			if ($query->rowCount() > 0) {
				...
				<div class="clearfix"></div>
					...
					<div class="latest">
						...
						<div class="pic">
							<a class="fancybox" href="images/6.jpeg" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet"><img src="images/6.jpg" class="img-style row6" alt=""><span> </span></a>
							<h4><a href="">Aenean rutrum</a></h4>
							<p>Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
						</div>
						<div class="pic">
