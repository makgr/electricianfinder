...
<head>
	<title>Electrician Finder web application || Services</title>
	...
	<div class="event content">
		<div class="container">
			...
			<div class="event-grids">
							<div class="col-md-3 event-grid large-text">

								<ul>
									<li class="hedding">Service</li>

								</ul>
								<div class="clearfix"> </div>
							</div>
							<div class="col-md-4 event-grid large-text">
								<p>Description</p>
							</div>
